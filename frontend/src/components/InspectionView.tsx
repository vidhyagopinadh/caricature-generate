      ...
      <div className="p-5 flex-1 space-y-6">
        <div className="flex justify-end">
          <button
            ...
            className="px-3 py-1.5 bg-red-950/20 border border-red-900/40 hover:border-red-500/50 hover:bg-red-900/30 text-red-400 hover:text-red-200 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5"
